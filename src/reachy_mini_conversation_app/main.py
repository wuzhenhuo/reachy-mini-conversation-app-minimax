...
def run(
    ...
    from reachy_mini_conversation_app.minimax_handler import MinimaxHandler, _get_whisper
    from reachy_mini_conversation_app.tools.core_tools import ToolDependencies
    from reachy_mini_conversation_app.audio.head_wobbler import HeadWobbler

    logger = setup_logger(args.debug)
    threading.Thread(target=_get_whisper, daemon=True).start()  # Pre-load Whisper in background
    ...
    handler = MinimaxHandler(deps, gradio_mode=args.gradio, instance_path=instance_path)
