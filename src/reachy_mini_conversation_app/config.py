...
# ElevenLabs TTS voices (display name → voice ID).
...
AVAILABLE_VOICES: list[str] = list(ELEVENLABS_VOICE_MAP.keys())
...
class Config:
    ...
    # Optional
    OPENAI_BASE_URL = os.getenv("OPENAI_BASE_URL")  # Custom API base URL (e.g. for MiniMax)
